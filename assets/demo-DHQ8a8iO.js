import{n as e,r as t,s as n,t as r,u as i}from"./index-V8TBpLoD.js";import{M as a,Ot as o,St as s,T as c,a as l,c as u,g as d,o as f,vn as p}from"./tslib.es6-_D-OV5LH.js";import{i as m,n as h,r as g,t as _}from"./autoFit-B84T4mqB.js";import{a as v,i as y,n as b,r as x,t as S}from"./leva.esm-BvOJNSEq.js";import{t as C}from"./Center-B6meZ3eS.js";var w=i(n(),1),T=e(),E=()=>(0,T.jsx)(`ambientLight`,{intensity:x({intensity:{label:`Ambient light`,value:2.8,min:0,max:10}}).intensity}),D=()=>(0,T.jsx)(`pointLight`,{intensity:x({intensity1:{label:`Point light`,value:950,min:0,max:2e3}}).intensity1,position:[-5,20,0],distance:50}),O=f()(g(e=>({newStyle:!1,pureMode:!1,toggleMapStyle:()=>e(e=>({newStyle:!e.newStyle})),togglePureMode:()=>e(e=>({pureMode:!e.pureMode}))}))),k=r.button`
  position: relative;
  padding: 12px 24px;
  font-size: 18px;
  font-weight: bold;
...
`,V=r.div`
  ...
  display: flex;
  gap: 20px;
`;function H({items:e}){return(0,T.jsx)(R,{children:e.map(e=>(0,T.jsxs)(z,{children:[(0,T.jsx)(B,{children:e.badge}),(0,T.jsxs)(`span`,{children:[(0,T.jsx)(`strong`,{children:e.title}),(0,T.jsx)(`span`,{children:e.text})]})]},e.title))})}function U(){let e=(0,w.useRef)(null),t=h(`toBottom`,.6,1),n=h(`toRight`,.8,1.5),r=h(`toRight`,.8,1.5),i=h(`toLeft`,.8,1.5),a=h(`toLeft`,.8,1.5),o=h(`toTop`,.8,1.5,`translateX(-50%)`),s=O(e=>e.togglePureMode),c=O(e=>e.toggleMapStyle);return(0,w.useEffect)(()=>{let s=!0;o.restart(s);let c=O.subscribe(e=>e.pureMode,o=>{o?(t.reverse(),n.reverse(),r.reverse(),i.reverse(),a.reverse(),e.current.style.setProperty(`opacity`,`0`)):(t.restart(s),n.restart(s),r.restart(s),i.restart(s),a.restart(s),e.current.style.setProperty(`opacity`,`1`))},{fireImmediately:!0});return s=!1,()=>{s=!0,c()}},[]),(0,T.jsxs)(_,{children:[(0,T.jsx)(M,{ref:e}),(0,T.jsx)(I,{ref:t.ref,children:(0,T.jsxs)(F,{children:[`Contactor 3 Phase`,(0,T.jsx)(`span`,{children:`INTERACTIVE 3D DATA VISUALIZATION`})]})}),(0,T.jsxs)(N,{children:[(0,T.jsxs)(P,{ref:n.ref,style:{gridArea:`1 / 1 / 3 / 2`},children:[(0,T.jsxs)(L,{children:[`Main Power Contacts`,(0,T.jsx)(`span`,{children:`L1 L2 L3 / T1 T2 T3`})]}),(0,T.jsx)(H,{items:[{badge:`3P`,title:`Three-phase switching`,text:`The main contacts connect and disconnect the motor supply lines.`},{badge:`IN`,title:`Line terminals`,text:`L1, L2, L3 receive the incoming three-phase power source.`},{badge:`OUT`,title:`Load terminals`,text:`T1, T2, T3 send power to the motor or three-phase load.`}]})]}),(0,T.jsxs)(P,{ref:r.ref,style:{gridArea:`3 / 1 / 5 / 2`},children:[(0,T.jsxs)(L,{children:[`Auxiliary Contacts`,(0,T.jsx)(`span`,{children:`13-14 / 21-22`})]}),(0,T.jsx)(H,{items:[{badge:`NO`,title:`Normally open contact`,text:`13-14 closes when the contactor coil is energized.`},{badge:`NC`,title:`Normally closed contact`,text:`21-22 opens when the contactor changes state.`},{badge:`FB`,title:`Control feedback`,text:`Used for self-holding, indicator lamps, PLC input, and interlocks.`}]})]}),(0,T.jsxs)(P,{ref:i.ref,style:{gridArea:`1 / 4 / 3 / 5`},children:[(0,T.jsxs)(L,{children:[`Coil Supply Terminals`,(0,T.jsx)(`span`,{children:`A1 / A2`})]}),(0,T.jsx)(H,{items:[{badge:`A1`,title:`Coil input`,text:`A1 receives the control voltage from the start circuit.`},{badge:`A2`,title:`Coil return`,text:`A2 returns to neutral or the second control line.`},{badge:`MAG`,title:`Magnetic action`,text:`When energized, the coil pulls the armature and closes the main contacts.`}]})]}),(0,T.jsxs)(P,{ref:a.ref,style:{gridArea:`3 / 4 / 5 / 5`},children:[(0,T.jsxs)(L,{children:[`Functions and Uses`,(0,T.jsx)(`span`,{children:`MOTOR CONTROL`})]}),(0,T.jsx)(H,{items:[{badge:`RUN`,title:`Remote motor control`,text:`Starts and stops a three-phase motor from push buttons or a PLC.`},{badge:`SAFE`,title:`Protection coordination`,text:`Works with overload relays, fuses, and breakers for safer operation.`},{badge:`REV`,title:`Reversing and interlock`,text:`Two contactors can reverse motor direction with electrical interlocking.`}]})]}),(0,T.jsxs)(V,{ref:o.ref,children:[(0,T.jsx)(j,{onClick:c,children:`Switch Style`}),(0,T.jsx)(j,{onClick:s,children:`Focus Mode`})]})]})]})}var W=`/contactor-3d-viewer/models/magnetic-contactor.glb`;function G(){let e=(0,w.useRef)(null),t=v(W);return(0,T.jsx)(C,{children:(0,T.jsx)(`object3D`,{ref:e,children:(0,T.jsx)(`primitive`,{object:(0,w.useMemo)(()=>{let e=t.scene.clone(!0),n=new c().setFromObject(e),r=new p,i=new p;n.getSize(r),n.getCenter(i),e.position.sub(i);let a=Math.max(r.x,r.y,r.z),l=a>0?8/a:1;return e.scale.setScalar(l),e.traverse(e=>{if(e instanceof s){e.castShadow=!0,e.receiveShadow=!0;let t=e.material;t instanceof o&&(t.roughness=Math.min(t.roughness+.12,1),t.metalness=Math.max(t.metalness,.05))}}),e},[t.scene])})})})}function K(){return(0,T.jsx)(m,{center:!0,children:(0,T.jsx)(`div`,{style:{color:`#5a4a42`,fontWeight:700,padding:`10px 14px`,border:`1px solid rgba(234, 88, 12, 0.28)`,borderRadius:4,background:`rgba(255, 245, 232, 0.86)`,whiteSpace:`nowrap`},children:`Loading 3D model...`})})}function q(){let e=d(e=>e.camera),n=d(e=>e.scene);return(0,w.useLayoutEffect)(()=>{n.background=new a(`#f6efe7`);let r=t.fromTo(e.position,{x:-8,y:6,z:12},{x:6,y:4,z:10,duration:1.2,ease:`sine.inOut`});return()=>{r.kill()}},[e,n]),(0,T.jsxs)(`group`,{position:[0,-.3,0],children:[(0,T.jsx)(G,{}),(0,T.jsxs)(`mesh`,{rotation:[-Math.PI/2,0,0],position:[0,-3.1,0],receiveShadow:!0,children:[(0,T.jsx)(`circleGeometry`,{args:[5.6,96]}),(0,T.jsx)(`meshStandardMaterial`,{color:`#f8dec1`,roughness:.85})]})]})}v.preload(W);var J=r.div`
  position: relative;
  width: 100vw;
  height: 100vh;
  background: #f6efe7;
