...
`),gt=Z.forwardRef(({children:e,color:t,segments:n=1,scale:r=1,zoom:i=1,grayscale:a=0,opacity:o=1,radius:s=0,texture:c,toneMapped:l,transparent:u,side:d,...f},p)=>{v({ImageMaterial:ht});let m=Z.useRef(null),h=b(e=>e.size),g=Array.isArray(r)?[r[0],r[1]]:[r,r],_=[c.image.width,c.image.height],x=Math.max(h.width,h.height);return Z.useImperativeHandle(p,()=>m.current,[]),Z.useLayoutEffect(()=>{m.current.geometry.parameters&&m.current.material.scale.set(g[0]*m.current.geometry.parameters.width,g[1]*m.current.geometry.parameters.height)},[g[0],g[1]]),Z.createElement(`mesh`,y({ref:m,scale:Array.isArray(r)?[...r,1]:r},f),Z.createElement(`planeGeometry`,{args:[1,1,n,n]}),Z.createElement(`imageMaterial`,{color:t,map:c,zoom:i,grayscale:a,opacity:o,scale:g,imageBounds:_,resolution:x,radius:s,toneMapped:l,transparent:u,side:d,key:ht.key}),e)}),_t=Z.forwardRef(({url:e,...t},n)=>{let r=T(e);return Z.createElement(gt,y({},t,{texture:r,ref:n}))}),vt=Z.forwardRef(({url:e,...t},n)=>Z.createElement(gt,y({},t,{ref:n}))),yt=Z.forwardRef((e,t)=>{if(e.url)return Z.createElement(_t,y({},e,{ref:t}));if(e.texture)return Z.createElement(vt,y({},e,{ref:t}));throw Error(`<Image /> requires a url or texture`)}),$=t(),bt=v(C({u_time:0,u_resolution:new u,u_aspect:0,u_noiseFreq:0,blur:0,speed:0},` varying vec2 vUv;
...
}`));function xt(){let e=b(),t=(0,Z.useRef)(null);return f(e=>{t.current.uniforms.u_time.value=e.clock.getElapsedTime()}),(0,$.jsx)(`group`,{position:[0,-3,-10],children:(0,$.jsxs)(`mesh`,{children:[(0,$.jsx)(`planeGeometry`,{args:[6,6,16,16]}),(0,$.jsx)(bt,{transparent:!0,ref:t,wireframe:!1,u_aspect:e.viewport.aspect,blur:0,speed:.5,u_noiseFreq:1})]})})}var St=i.div`
  position: relative;
  width: 100vw;
  height: 100vh;
`,Ct=v(class extends c{constructor(e,t,n,r,i){super(t,n,r,i);let a=this.parameters.width*.5,o=new h(-a,0),s=new h(0,e),c=new h(a,0),l=new h().subVectors(o,s),u=new h().subVectors(s,c),d=new h().subVectors(o,c),f=new h(0,e-l.length()*u.length()*d.length()/(2*Math.abs(l.cross(d)))),p=(new h().subVectors(o,f).angle()-Math.PI*.5)*2,m=this.attributes.uv,g=this.attributes.position,_=new h;for(let e=0;e<m.count;e++){let t=m.getX(e),n=g.getY(e);_.copy(c).rotateAround(f,p*t),g.setXYZ(e,_.x,n,-_.y)}g.needsUpdate=!0}}),wt=i.div`
  position: absolute;
  bottom: 20px;
  left: 50%;
...
`;function Et(){return(0,$.jsxs)(St,{children:[(0,$.jsxs)(_,{camera:{position:[0,0,100],fov:15},children:[(0,$.jsx)(`fog`,{attach:`fog`,args:[`#6e6e6e`,8.5,12]}),(0,$.jsx)(mt,{pages:4,infinite:!0,children:(0,$.jsx)(Dt,{rotation:[0,0,.15],children:(0,$.jsx)(Ot,{})})}),(0,$.jsx)(xt,{})]}),(0,$.jsx)(wt,{children:(0,$.jsxs)(`svg`,{width:`20`,height:`32.5`,viewBox:`0 0 40 65`,children:[(0,$.jsx)(`rect`,{x:`2.5`,y:`2.5`,width:`35`,height:`60`,rx:`17.5`,ry:`17.5`,fill:`none`,stroke:`currentColor`,strokeWidth:`3`}),(0,$.jsx)(Tt,{cx:`20`,cy:`15`,r:`3`,fill:`currentColor`})]})})]})}function Dt(e){let t=(0,Z.useRef)(null),n=pt(),r=(0,Z.useRef)(new p(1,1,1));return f((e,i)=>{t.current.rotation.y=-n.offset*(Math.PI*2),e.events.update?.(),r.current.set(-e.pointer.x*2,e.pointer.y+1.5,10),e.camera.position.lerp(r.current,1-Math.exp(-8*i)),e.camera.lookAt(0,0,0)}),(0,$.jsx)(`group`,{ref:t,...e})}function Ot({radius:e=1.4,count:t=8}){let n=a();return Array.from({length:t},(r,i)=>(0,$.jsx)(kt,{url:`/demo_${i%4}.jpg`,position:[Math.sin(i/t*Math.PI*2)*e,0,Math.cos(i/t*Math.PI*2)*e],rotation:[0,Math.PI+i/t*Math.PI*2,0],onClick:e=>{e.stopPropagation(),n([`/demo0`,`/demo1`,`/demo2`,`/demo3`][i%4])}},i))}function kt(e){let t=(0,Z.useRef)(null),n=(0,Z.useRef)(new p(1,1,1)),r=(0,Z.useRef)(.1),i=(0,Z.useRef)(1.5);return f((e,a)=>{t.current.scale.lerp(n.current,1-Math.exp(-10*a)),t.current.material.radius=m.lerp(t.current.material.radius,r.current,1-Math.exp(-8*a)),t.current.material.zoom=m.lerp(t.current.material.zoom,i.current,1-Math.exp(-8*a))}),(0,$.jsx)(yt,{ref:t,transparent:!0,toneMapped:!1,side:2,onPointerOver:e=>{e.stopPropagation(),n.current.setScalar(1.15),r.current=.25,i.current=1,document.body.style.cursor=`pointer`},onPointerOut:()=>{n.current.setScalar(1),r.current=.1,i.current=1.5,document.body.style.cursor=`auto`},...e,children:(0,$.jsx)(Ct,{args:[.1,1,1,20,20]})})}export{Et as default};